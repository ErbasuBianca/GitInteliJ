...
/*
Instructions In this exercise you're going to write some code to help you cook a brilliant lasagna
from your favorite cooking book.

You have four tasks, all related to the time spent cooking the lasagna.

Define the expected oven time in minutes
Define the expectedMinutesInOven() method that does not take any parameters and returns how
many minutes the lasagna should be in the oven. According to the cooking book,
...
Define the preparationTimeInMinutes() method that takes the number of layers you
added to the lasagna as a parameter and returns how many minutes you spent
...
parameter is the number of layers you added to the lasagna, and the second parameter is the number
...
// => 26
 */
public class JavaLasagna {
    public static void main(String[] args) {
        Lasagna lasagna = new Lasagna();
        lasagna.expectedMinuteInOven();
        System.out.println("1. " + lasagna.expectedMinuteInOven());
        System.out.println("2. " + lasagna.remainingMinutesInOven(30));
        System.out.println("3. " + lasagna.preparationTimeInMinutes(2));
        System.out.println("4. " + lasagna.totalTimeInMinutes(3, 20));
